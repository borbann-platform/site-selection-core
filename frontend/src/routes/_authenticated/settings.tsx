          ...
          <div className="grid gap-8">
            ...
            <section className="space-y-4">
              ...
              <div className="bg-card border border-border rounded-2xl overflow-hidden">
                <div className="p-6 border-b border-border flex items-center justify-between hover:bg-muted/30 transition-colors duration-150">
                  <div>
                ...
                <div className="p-6 flex items-center justify-between hover:bg-muted/30 transition-colors duration-150">
                  <div>
                  ...
                  <button
                    type="button"
                    onClick={logout}
                    className="flex items-center gap-2 px-4 py-2 bg-red-500/20 hover:bg-red-500/30 text-red-400 rounded-lg text-sm font-medium transition-all duration-150 active:scale-[0.97]"
                  >
                    <LogOut size={16} />
                    Sign Out
                  </button>
            ...
            <section className="space-y-4">
              ...
              <div className="bg-card border border-border rounded-2xl overflow-hidden">
                <div className="p-6 border-b border-border flex items-center justify-between hover:bg-muted/30 transition-colors duration-150">
                  ...
                  <select className="bg-input border border-border rounded px-3 py-1 text-sm transition-colors duration-150">
                    <option>1 km</option>
                    <option>2 km</option>
                    <option>5 km</option>
                  </select>
                ...
                <div className="p-6 flex items-center justify-between hover:bg-muted/30 transition-colors duration-150">
                  ...
                  <div className="flex bg-input rounded-lg p-1 border border-border">
                    <button
                      type="button"
                      className="px-3 py-1 rounded bg-muted text-xs font-bold transition-all duration-200"
                    >
                      Walk
                    </button>
                    <button
                      type="button"
                      className="px-3 py-1 rounded text-muted-foreground text-xs font-bold hover:text-foreground transition-all duration-200"
                    >
                      Drive
                    </button>
                  </div>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold flex items-center gap-2">
                <span className="p-1.5 rounded-lg bg-yellow-500/10">
              ...
              <div className="bg-card border border-border rounded-2xl overflow-hidden">
                <div className="p-6 flex items-center justify-between hover:bg-muted/30 transition-colors duration-150">
                  ...
                  <div className="w-10 h-6 bg-emerald-500 rounded-full relative cursor-pointer transition-colors duration-200 hover:bg-emerald-400">
                    <div className="absolute right-1 top-1 w-4 h-4 bg-white rounded-full shadow-sm transition-all duration-200" />
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="bg-card border border-border rounded-2xl overflow-hidden">
                <div className="p-6 flex items-center justify-between hover:bg-muted/30 transition-colors duration-150">
                  ...
                  <button
                    type="button"
                    className="text-sm font-bold text-muted-foreground hover:text-foreground transition-colors duration-150"
                  >
                    Manage
                  </button>
                </div>
              ...
              <div className="bg-card border border-border rounded-2xl overflow-hidden">
                ...
                <div className="p-6 border-b border-border flex items-center justify-between hover:bg-muted/30 transition-colors duration-150">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-400 rounded-lg text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-150 active:scale-[0.97]"
                  >
                    {isRefreshingPOIs ? (
                ...
                <div className="p-6 flex items-center justify-between hover:bg-muted/30 transition-colors duration-150">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-orange-500/20 hover:bg-orange-500/30 text-orange-400 rounded-lg text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-150 active:scale-[0.97]"
                  >
                    {isClearingCache ? (
                      <Loader2 size={16} className="animate-spin" />
                    ) : (
