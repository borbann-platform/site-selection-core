    ...
    <div className="border-t border-white/10">
      ...
      >
        <div className="flex items-center gap-2">
          <span className="text-xs font-medium text-white/70">Quick Filters</span>
          {hasActiveFilters && (
        ...
        <div className="px-4 pb-4 space-y-3">
          ...
          <div className="space-y-1">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-white/5 border border-white/10 rounded px-2 py-1.5 text-xs text-white placeholder:text-white/30 focus:outline-none focus:border-emerald-500/50"
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded px-2 py-1.5 text-xs text-white placeholder:text-white/30 focus:outline-none focus:border-emerald-500/50"
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full bg-white/5 border border-white/10 rounded px-2 py-1.5 text-xs text-white focus:outline-none focus:border-emerald-500/50"
          ...
          <div className="space-y-2 pt-2">
            <label className="flex items-center gap-2 cursor-pointer group">
              <input
                ...
                className="w-3.5 h-3.5 rounded bg-white/5 border border-white/20 checked:bg-emerald-500 checked:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500/50"
              />
          ...
          {hasActiveFilters && (
            <button
              ...
              className="w-full mt-2 px-3 py-1.5 text-xs text-white/50 hover:text-white hover:bg-white/5 rounded transition-colors"
            >
              Clear all filters
            </button>
          )}
